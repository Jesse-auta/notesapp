                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <nav className="flex items-center gap-2 text-sm font-medium text-slate-500">
                            ...
                            <span className="text-slate-900">{note?.title || "Untitled"}</span>
                        </nav>
                        <div className="flex gap-2">
                            <button
                                onClick={() => setEditing(true)}
                                className="flex items-center gap-2 rounded-lg h-9 px-3 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 text-sm font-semibold shadow-sm transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 rounded-lg h-9 px-3 bg-white border border-red-200 text-red-600 hover:bg-red-50 text-sm font-semibold shadow-sm transition-colors"
                            >
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-slate-900 text-lg font-bold">AI Summary</h3>
                                </div>
                                <button
                            ...
                            <div className="bg-white/60 rounded-xl p-4 border border-white/50">
                                {note?.summary ? (
                                    <p className="text-slate-700 text-base leading-relaxed">{note.summary}</p>
                                ) : (
                    ...
                    {/* Note content */}
                    <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm min-h-[300px]">
                    ...
                    <div className="flex items-center justify-between py-4 border-t border-slate-200">
                        ...
                        <div className="text-slate-400 text-xs">{wordCount} words</div>
                    </div>
                </div>
            </main>
